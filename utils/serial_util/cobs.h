...
/**
 *  Unstuffs "length" bytes of data at the location pointed to by "input", 
 *  writing the output to the location pointed to by "output". Returns the 
 *  number of bytes written to "output" if "input" was successfully unstuffed, 
 *  and 0 if there was an error unstuffing "input". Trim the end zero  of 
 *  the cobs string before sending it.
 ...
 * @return number of bytes if "input" was successfully unstuffed, 0 if there 
 * was an error unstuffing input
 */
